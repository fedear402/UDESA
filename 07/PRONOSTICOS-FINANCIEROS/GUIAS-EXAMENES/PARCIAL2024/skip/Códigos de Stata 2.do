...
log close //Conviene siempre cerrar el logfile al final
...
*Para cointegracion o pasos de boxjenkigs
*Necesitamos que la serie sea estacionaria asiq  haces un dfuller con los lags necesarios primero
*“q” se determina con el gráfico de la función de AC y “p” se determina con el gráfico de la función de PAC
*Despues ves si los residues son ruido blanco
arima nombrevar, ar(1) ma(7,8)
predict resid1, residuals
wntestq resid1
//Para conocer las raíces inversas
estat aroots //Necesariamente necesitamos que sean menores al modulo de 1
