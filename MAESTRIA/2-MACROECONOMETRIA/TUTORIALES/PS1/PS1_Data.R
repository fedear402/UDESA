...
# Este código baja la última vesión disponible:
# i) contra: depende de tener conexión a Internet.
# ii) pro: siempre actualziado
#------------------------------------------------------------------------------#
...
download.file("https://www.imf.org/-/media/Files/Research/CommodityPrices/Monthly/external-data.ashx", 
              pcom.file, mode = "wb")
...
# Read data, we want the variable:
...
# We are going to merge/join series

# Historical CPI
# We are going to load the data directly from Internet
