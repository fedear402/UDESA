...
class SimuladorMina:
    ...
    def visualizar_producción(self, df_producción=None, guardar=True):
        ...
        if guardar:
            plt.savefig(f'produccion_{timestamp}.png', dpi=300, bbox_inches='tight')
    ...
    def visualizar_regalías(self, df_regalías=None, acumulado=True, guardar=True):
        ...
        if guardar:
            plt.savefig(f'regalias_{timestamp}.png', dpi=300, bbox_inches='tight')
    ...
    def visualizar_monte_carlo(self, guardar=True):
        ...
        if guardar:
            plt.savefig(f'monte_carlo_{timestamp}.png', dpi=300, bbox_inches='tight')
