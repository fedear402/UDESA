...
shocks        ={'a'}; %nombre de variables shockeadas, con el mismo nombre que el declarado en Dynare (este programa asume que si la vraiable es, por ejemplo, 'a', el shocks es llamado 'u_a' en el mod-file)
shocks_latex  ={'a_t'}; %nombre que aparecera en el titulo de cada IRF para cada variable ex�gena. Se permite escribir en formato LaTex

v_sel         = {'y'  ,'c'  ,'ii'  ,'h'  ,'tby'}; %nombre de las variables cuyo irf desean mostrarse, con el mismo nombre que el declarado en Dynare
v_name        = {'y_t','c_t', 'i_t','h_t','tby_t'};%nombre que aparecera en el titulo de cada IRF para cada variable ex�gena. Se permite escribir en formato LaTex.
...
plot_options.y_limits = {
    [0 2],         % For variable 1
    [0 2],         % For variable 2
    [-2 8],             % Leave empty to auto-scale
    [0 2],             % Leave empty to auto-scale
    [-1 1],             % Leave empty to auto-scale
    [0 1]           % Leave empty to auto-scale
};
